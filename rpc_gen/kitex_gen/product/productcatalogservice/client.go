...
func (p *kProductCatalogServiceClient) GetAllCategory(ctx context.Context, Req *product.GetAllCategoryReq, callOptions ...callopt.Option) (r *product.GetAllCategoryResp, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.GetAllCategory(ctx, Req)
}
