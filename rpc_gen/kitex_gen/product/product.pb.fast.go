...
func (x *GetAllCategoryResp) FastRead(buf []byte, _type int8, number int32) (offset int, err error) {
	switch number {
	case 1:
		offset, err = x.fastReadField1(buf, _type)
		if err != nil {
...
SkipFieldError:
	return offset, fmt.Errorf("%T cannot parse invalid wire-format data, error: %s", x, err)
ReadFieldError:
	return offset, fmt.Errorf("%T read field %d '%s' error: %s", x, number, fieldIDToName_GetAllCategoryResp[number], err)
}

func (x *GetAllCategoryResp) fastReadField1(buf []byte, _type int8) (offset int, err error) {
	var v string
	v, offset, err = fastpb.ReadString(buf, _type)
	if err != nil {
		return offset, err
...
func (x *GetAllCategoryReq) FastRead(buf []byte, _type int8, number int32) (offset int, err error) {
	switch number {
	default:
		offset, err = fastpb.Skip(buf, _type, number)
		if err != nil {
...
func (x *GetAllCategoryResp) FastWrite(buf []byte) (offset int) {
	if x == nil {
		return offset
	}
	offset += x.fastWriteField1(buf[offset:])
...
func (x *GetAllCategoryResp) fastWriteField1(buf []byte) (offset int) {
	if len(x.Categories) == 0 {
		return offset
	}
	for i := range x.GetCategories() {
...
func (x *GetAllCategoryReq) FastWrite(buf []byte) (offset int) {
	if x == nil {
		return offset
	}
	return offset
...
func (x *GetAllCategoryResp) Size() (n int) {
	if x == nil {
		return n
	}
	n += x.sizeField1()
...
func (x *GetAllCategoryResp) sizeField1() (n int) {
	if len(x.Categories) == 0 {
		return n
	}
	for i := range x.GetCategories() {
...
func (x *GetAllCategoryReq) Size() (n int) {
	if x == nil {
		return n
	}
	return n
...
var fieldIDToName_GetAllCategoryResp = map[int32]string{
	1: "Categories",
}

var fieldIDToName_GetAllCategoryReq = map[int32]string{}
