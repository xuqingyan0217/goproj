...
func (x *CancelPaymentReq) fastReadField4(buf []byte, _type int8) (offset int, err error) {
...
SkipFieldError:
	return offset, fmt.Errorf("%T cannot parse invalid wire-format data, error: %s", x, err)
ReadFieldError:
	return offset, fmt.Errorf("%T read field %d '%s' error: %s", x, number, fieldIDToName_ChangeOrderStatusResp[number], err)
}

func (x *ChangeOrderStatusResp) fastReadField1(buf []byte, _type int8) (offset int, err error) {
	x.Success, offset, err = fastpb.ReadBool(buf, _type)
	return offset, err
}
...
func (x *CancelPaymentReq) fastWriteField4(buf []byte) (offset int) {
	if x.Status == "" {
		return offset
	}
	offset += fastpb.WriteString(buf[offset:], 4, x.GetStatus())
	return offset
}
...
func (x *ChangeOrderStatusResp) fastWriteField1(buf []byte) (offset int) {
	if !x.Success {
		return offset
	}
	offset += fastpb.WriteBool(buf[offset:], 1, x.GetSuccess())
...
func (x *CancelPaymentReq) sizeField4() (n int) {
	if x.Status == "" {
		return n
	}
	n += fastpb.SizeString(4, x.GetStatus())
	return n
}
...
func (x *ChangeOrderStatusResp) sizeField1() (n int) {
	if !x.Success {
		return n
	}
	n += fastpb.SizeBool(1, x.GetSuccess())
