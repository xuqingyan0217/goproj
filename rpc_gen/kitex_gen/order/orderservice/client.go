...
func (p *kOrderServiceClient) CancelPayment(ctx context.Context, Req *order.CancelPaymentReq, callOptions ...callopt.Option) (r *order.CancelPaymentResp, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
