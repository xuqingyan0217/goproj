...
func GetAllCategory(ctx context.Context, req *product.GetAllCategoryReq, callOptions ...callopt.Option) (resp *product.GetAllCategoryResp, err error) {
	resp, err = defaultClient.GetAllCategory(ctx, req, callOptions...)
	if err != nil {
		klog.CtxErrorf(ctx, "GetAllCategory call failed,err =%+v", err)
		return nil, err
	}
	return resp, nil
}
